...
import pm.controller.CanvasController;
import pm.controller.PoseEditController;
import pm.data.DataManager;
import static pm.data.DataManager.BLACK_HEX;
import static pm.data.DataManager.WHITE_HEX;
import pm.data.PoseMakerState;
...
public class Workspace extends AppWorkspaceComponent {
	...
	row3Box = new VBox();
        if(app.getFlag()==true)
        {
            backgroundColorLabel = new Label("Colore di sfondo");
        }
        else
        {
	...
	row4Box = new VBox();
        if(app.getFlag()==true)
        {
           fillColorLabel = new Label("Colore di riempimento");
        }
        else
        {
	...
	row5Box = new VBox();
        if(app.getFlag()==true)
        {
            outlineColorLabel = new Label("Contorno Colore");
        }
        else
        {
	...
	row6Box = new VBox();
        if(app.getFlag()==true)
        {
            outlineThicknessLabel = new Label("Spessore Outline");
        }
        else
        {
