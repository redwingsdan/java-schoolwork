...
public class AppStartupConstants
{
    ...
    public static final String SIMPLE_APP_PROPERTIES_FILE_NAME2 = "itl_simple_app_properties.xml";
    public static final String WORKSPACE_PROPERTIES_FILE_NAME2 = "itl_workspace_properties.xml";
    ...
    public static String CLOSE_BUTTON_LABEL2 = "Uscita";
    
    public void setClose()
    {
        CLOSE_BUTTON_LABEL = "Uscita";
    }
}