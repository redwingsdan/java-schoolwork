...
import saf.ui.AppLanguageDialogSingleton;
...
import saf.settings.AppStartupConstants;
...
import static saf.settings.AppStartupConstants.SIMPLE_APP_PROPERTIES_FILE_NAME2;
import static saf.settings.AppStartupConstants.WORKSPACE_PROPERTIES_FILE_NAME;
import static saf.settings.AppStartupConstants.WORKSPACE_PROPERTIES_FILE_NAME2;
...
public abstract class AppTemplate extends Application {
	...
	AppYesNoCancelDialogSingleton yesNoDialog = AppYesNoCancelDialogSingleton.getSingleton();
        ...
        AppLanguageDialogSingleton yesNoDialog2 = AppLanguageDialogSingleton.getSingleton();
        yesNoDialog2.init2(primaryStage, "English", "Italian");
        yesNoDialog2.show("Language Select", "Which language would you like to use?");
        String selection = yesNoDialog2.getSelection();
        
        PropertiesManager props = PropertiesManager.getPropertiesManager();
        
         if (selection.equals("Italian")) {
              try {
                  AppStartupConstants.CLOSE_BUTTON_LABEL = "Uscita";
                  yesNoDialog.init2(primaryStage, "Si", "No", "Cancello");
                  flag = true;
	    // LOAD APP PROPERTIES, BOTH THE BASIC UI STUFF FOR THE FRAMEWORK
	    // AND THE CUSTOM UI STUFF FOR THE WORKSPACE
	    boolean success = loadProperties(SIMPLE_APP_PROPERTIES_FILE_NAME2)
		    && loadProperties(WORKSPACE_PROPERTIES_FILE_NAME2);
	...
	try {
            ...
            yesNoDialog.init2(primaryStage, "Yes", "No", "Cancel");
	    // LOAD APP PROPERTIES, BOTH THE BASIC UI STUFF FOR THE FRAMEWORK
	    // AND THE CUSTOM UI STUFF FOR THE WORKSPACE
